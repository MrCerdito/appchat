...
__decorate([
    (0, typeorm_1.Column)({ name: 'sender_type', length: 10 }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => session_entity_1.Session, (session) => session.messages, {
        onDelete: 'CASCADE',
    }),
...
exports.Message = Message = __decorate([
    ...
    (0, typeorm_1.Index)('idx_messages_session_id', ['session']),
    (0, typeorm_1.Index)('idx_messages_session_id_created_at', ['session', 'createdAt'])
], Message);
