...
const ICONS: Record<string, string> = {
  ...
  'address-book': '<path d="M20 6v12a2 2 0 0 1 -2 2h-10a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2h10a2 2 0 0 1 2 2z" /><path d="M10 16h6" /><path d="M13 11m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" /><path d="M4 8h3" /><path d="M4 12h3" /><path d="M4 16h3" />',
  ...
  'chevrons-down': '<path d="M7 6l5 5l5 -5" /><path d="M7 12l5 5l5 -5" />',
  'circle-check': '<path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /><path d="M9 12l2 2l4 -4" />',
  'panel-right-open': '<rect x="3" y="3" width="18" height="18" rx="2" /><path d="M15 3v18" />',
  'panel-right-close': '<rect x="3" y="3" width="18" height="18" rx="2" /><path d="M11 3v18" />',
  ...
  'corner-up-left': '<path d="M9 14l-4 -4l4 -4" /><path d="M5 10h11a4 4 0 0 1 0 8h-1" />',
  'corner-up-right': '<path d="M15 14l4 -4l-4 -4" /><path d="M19 10h-11a4 4 0 0 0 0 8h1" />',
  ...
  'login-2': '<path d="M9 8v-2a2 2 0 0 1 2 -2h7a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-7a2 2 0 0 1 -2 -2v-2" /><path d="M3 12h13l-3 -3" /><path d="M13 15l3 -3" />',
  ...
  pin: '<path d="M15 4.5l-4 4l-4 -1l-3 3l2 2l3 -3l1 4l4 -4l4.5 1.5a1.5 1.5 0 0 1 .5 2l-5 5a1.5 1.5 0 0 1 -2 -.5l-1.5 -4.5l-5 5l2 2l5 -5l-4.5 -1.5a1.5 1.5 0 0 1 2 -.5l5 5a1.5 1.5 0 0 1 -.5 2" />',
  ...
  'player-stop-filled': '<path d="M17 4h-10a3 3 0 0 0 -3 3v10a3 3 0 0 0 3 3h10a3 3 0 0 0 3 -3v-10a3 3 0 0 0 -3 -3z" stroke-width="0" fill="currentColor" />',
  ...
  'plug-connected-x': '<path d="M20 16l-4 4" /><path d="M7 12l5 5l-1.5 1.5a3.536 3.536 0 1 1 -5 -5l1.5 -1.5z" /><path d="M17 12l-5 -5l1.5 -1.5a3.536 3.536 0 1 1 5 5l-1.5 1.5z" /><path d="M3 21l2.5 -2.5" /><path d="M18.5 5.5l2.5 -2.5" /><path d="M10 11l-2 2" /><path d="M13 14l-2 2" /><path d="M16 16l4 4" />',
  plus: '<path d="M12 5l0 14" /><path d="M5 12l14 0" />',
  refresh: '<path d="M20 11a8.1 8.1 0 0 0 -15.5 -2m-.5 -4v4h4" /><path d="M4 13a8.1 8.1 0 0 0 15.5 2m.5 4v-4h-4" />',
  search: '<path d="M10 10m-7 0a7 7 0 1 0 14 0a7 7 0 1 0 -14 0" /><path d="M21 21l-6 -6" />',
  'send-2': '<path d="M4.698 4.034l16.302 7.966l-16.302 7.966a.503 .503 0 0 1 -.546 -.124a.555 .555 0 0 1 -.12 -.568l2.468 -7.274l-2.468 -7.274a.555 .555 0 0 1 .12 -.568a.503 .503 0 0 1 .546 -.124z" /><path d="M6.5 12h14.5" />',
  ...
  'video-plus': '<path d="M15 10l4.553 -2.276a1 1 0 0 1 1.447 .894v6.764a1 1 0 0 1 -1.447 .894l-4.553 -2.276v-4z" /><path d="M3 6m0 2a2 2 0 0 1 2 -2h8a2 2 0 0 1 2 2v8a2 2 0 0 1 -2 2h-8a2 2 0 0 1 -2 -2z" /><path d="M7 12l4 0" /><path d="M9 10l0 4" />',
...
@Component({
  ...
  standalone: true,
  styles: [`
    :host{display:inline-flex;align-items:center;justify-content:center;flex:0 0 auto;line-height:1}
    :host(.spin){animation:waSpin 1s linear infinite}
...
export class WaIconComponent implements OnChanges {
  @Input() name: string = '';
